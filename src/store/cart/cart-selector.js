...
export const selectCartItems = createSelector([extractCartReducer], (cartSlice) => cartSlice.cartItems); // state.cart.cartItems

export const selectIsCartOpen = createSelector([extractCartReducer], (cartSlice) => cartSlice.isCartOpen); // state.cart.isCartOpen
