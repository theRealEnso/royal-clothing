...
const middleWares = [process.env.NODE_ENV === 'development' && loggerMiddleware].filter(Boolean); //filter out anything that is not true / is falsy.
...
//implement chrome extension redux-devtools => if we are in development, and there is a window object, and redux devtools exist, then use this compose. Otherwise, just use compose from redux
